...
const HighlightDuplicates2 = () => {
    ...
    useEffect(() => {
        $.ajax({
            type: "GET",
            url: `${api_base_url}/operations/highlight_duplicates2/${operation_id}`,
            headers: {
                Authorization: `Bearer ${access_token}`,
            },
                        ...
                        <div className="dashboard-breadcrumb">
                            <div className="dashboard-breadcrumb-left">
                                <h3 className="dashboard-breadcrumb-title">
                                    Highlight Duplicates 2
                                </h3>
                                <p className="dashboard-breadcrumb-text">
                                    An highlight duplicates and return 2 files
                                    operation performed by you
                                </p>
                            </div>
                            ...
                            <div className="file">
                                <div className="file-header">
                                    ...
                                    <div className="file-action-btns">
                                        ...
                                        <a
                                            href={`${base_url}dc/${user_id}/${operation_info.analytics_file_details.file_name}`}
                                            target="_new"
                                            className="change-file-btn"
                                        >
                                            Download
                                ...
                                <div className="file-preview-box">
                                    <table className="file-table">
                                        <thead>
                                            <tr>
                                                {operation_info.analytics_file_details.file_content[0].map(
                                                    (cell, i) => {
                                                        return (
                                                            <th
                                                                key={i}
                                        ...
                                        <tbody>
                                            {operation_info.analytics_file_details.file_content
                                                .slice(1)
                                                .map((row, i) => {
                                                    return (
                                                        <tr key={i}>
...
export default HighlightDuplicates2;
