...
const RemoveDuplicates2 = () => {
    ...
    useEffect(() => {
        $.ajax({
            type: "GET",
            url: `${api_base_url}/operations/remove_duplicates2/${operation_id}`,
            headers: {
                        ...
                        <div className="dashboard-breadcrumb">
                            <div className="dashboard-breadcrumb-left">
                                ...
                                <p className="dashboard-breadcrumb-text">
                                    A remove duplicates and return 2 files
                            ...
                            <div className="file">
                                ...
                                <div className="file-preview-box">
                                    <table className="file-table">
                                        <thead>
                                            <tr>
                                                {operation_info.duplicates_file_details.file_content[0].map(
                                                    (cell, i) => {
                                                        return (
                                                            <th
                                                                key={i}
                                        ...
                                        <tbody>
                                            {operation_info.duplicates_file_details.file_content
                                                .slice(1)
                                                .map((row, i) => {
                                                    return (
                                                        <tr key={i}>
